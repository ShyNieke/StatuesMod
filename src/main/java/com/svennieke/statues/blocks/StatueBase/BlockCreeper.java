...
public class BlockCreeper extends BaseCutout{
	
	private static final VoxelShape BOUNDING_BOX = Block.makeCuboidShape(6.5, 0, 6.5, 9.5, 9.5, 9.5);
	
	public BlockCreeper(Block.Properties builder) {
