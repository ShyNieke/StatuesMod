...
public class BlockCreeper_Statue_T3 extends BlockCreeper_Statue{
		
	private final String TAG_COOLDOWN = "cooldown";
	public static double cooldown;
	
	public BlockCreeper_Statue_T3() {
		super();
		setUnlocalizedName(Reference.StatuesBlocks.CREEPERSTATUET3.getUnlocalisedName());
		setRegistryName(Reference.StatuesBlocks.CREEPERSTATUET3.getRegistryName());
	...
	public int StatueBehavior(BlockCreeper_Statue_T3 statue, EntityPlayer playerIn, World worldIn, BlockPos pos) {
