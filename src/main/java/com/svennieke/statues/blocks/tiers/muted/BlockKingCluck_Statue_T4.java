...
public class BlockKingCluck_Statue_T4 extends BlockKingCluck_Statue{
		
	private final String TAG_COOLDOWN = "cooldown";
	public static double cooldown;
	
	public BlockKingCluck_Statue_T4() {
		super();
		setUnlocalizedName(Reference.StatuesBlocks.KINGCLUCKSTATUET4.getUnlocalisedName());
		setRegistryName(Reference.StatuesBlocks.KINGCLUCKSTATUET4.getRegistryName());
	}
	...
	public int StatueBehavior(BlockKingCluck_Statue_T4 statue, EntityPlayer playerIn) {
		if (cooldown < 0.01){
