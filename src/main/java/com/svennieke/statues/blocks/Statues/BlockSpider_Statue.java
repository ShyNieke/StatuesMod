...
public class BlockSpider_Statue extends BlockSpider implements ITileEntityProvider, IStatue {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		if(this.TIER >= 2)
		{
	        if (!worldIn.isRemote) {
	        	...
	        	tile.PlaySound(SoundEvents.ENTITY_SPIDER_AMBIENT, pos, worldIn);
	        	tile.GiveItem(stack1, stack2, stack3, playerIn);
	        	
	        	tile.FakeMobs(new FakeSpider(worldIn), worldIn, pos, false);
	        }
	        return true;
		}
		else
