...
public class BlockZombie_Statue extends BlockZombie implements iStatue, ITileEntityProvider{
	...
	public BlockZombie_Statue(String unlocalised, String registry, int tier) {
		super();
		this.TIER = tier;
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		if(this.TIER == 2 || this.TIER == 3 || this.TIER == 4)
		{
	        if (!worldIn.isRemote) {
	        	...
	        	int meta1 = StatuesConfigGen.statues.zombie.item1meta;
	        	int meta2 = StatuesConfigGen.statues.zombie.item2meta;
	        	int meta3 = StatuesConfigGen.statues.zombie.item3meta;
	        	
	        	ItemStack stack1 = new ItemStack(Item.getByNameOrId(StatuesConfigGen.statues.zombie.item1), 1, meta1);
        		ItemStack stack2 = new ItemStack(Item.getByNameOrId(StatuesConfigGen.statues.zombie.item2), 1, meta2);
        		ItemStack stack3 = new ItemStack(Item.getByNameOrId(StatuesConfigGen.statues.zombie.item3), 1, meta3);
