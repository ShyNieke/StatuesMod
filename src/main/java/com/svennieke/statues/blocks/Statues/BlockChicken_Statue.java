...
public class BlockChicken_Statue extends BlockChicken implements IStatue{
	
	private int TIER;
	
	public BlockChicken_Statue(Block.Properties builder) {
		super(builder);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) 
	{
		if(this.TIER == 1)
		{
			...
			if (block == Blocks.GOLD_BLOCK) {
	    		...
	    		worldIn.setBlockState(pos.down(), StatuesBlocks.kingcluck_statue_t1.getDefaultState().with(HORIZONTAL_FACING, placer.getHorizontalFacing().getOpposite()));
