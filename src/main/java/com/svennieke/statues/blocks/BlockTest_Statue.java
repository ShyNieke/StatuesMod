...
public class BlockTest_Statue extends BaseCutout{
	...
	public BlockTest_Statue() {
		super(Material.TNT);
		setUnlocalizedName(Reference.StatuesBlocks.TESTSTATUE.getUnlocalisedName());
		setRegistryName(Reference.StatuesBlocks.TESTSTATUE.getRegistryName());
	...
	/*public int StatueBehavior(BlockTest_Statue statue, EntityPlayer playerIn) {
