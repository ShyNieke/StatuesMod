...
public class StatuesConfigGen {
	...
	public static StatuesConfigurability statues = new StatuesConfigurability();
	...
	public static class General{
		...
		@Config.Comment("Setting this to true enables a recipe where the core is replaced by a diamond [ideal for singleplayer when tier 1 crafting is turned off] {requires restart} (Default: false)")
	...
	public static class StatuesConfigurability{
		...
		static Configuration getConfiguration() {
			if (configuration == null) {
				try {
					...
					Statues.logger.debug("Failed to get Configuration instance", throwable);
				}
			}
