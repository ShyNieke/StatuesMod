...
import com.shynieke.statues.blocks.StatueBase.BlockSlime;
...
public class BlockSlime_Statue extends BlockSlime implements ITileEntityProvider, IStatue {

	private int TIER;

	public BlockSlime_Statue(String unlocalised) {
		super();
