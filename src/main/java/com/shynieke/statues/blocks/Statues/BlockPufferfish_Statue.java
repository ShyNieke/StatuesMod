...
import com.shynieke.statues.blocks.StatueBase.BlockPufferfish;
...
public class BlockPufferfish_Statue extends BlockPufferfish implements ITileEntityProvider, IStatue {

	private int TIER;

	public BlockPufferfish_Statue(String unlocalised) {
		super(0);
