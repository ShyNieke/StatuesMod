...
import com.shynieke.statues.blocks.StatueBase.BlockZombie;
...
public class BlockZombie_Statue extends BlockZombie implements ITileEntityProvider, IStatue {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		if(this.TIER >= 2)
		{
	        if (!worldIn.isRemote) {
	        	...
	        	tile.FakeMobs(new FakeZombie(worldIn), worldIn, pos, false);
	        }
	        return true;
		}
		else
