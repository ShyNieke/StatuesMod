...
//
//public class PlayerBEWLR extends BlockEntityWithoutLevelRenderer { TODO: Figure out how to re-implement this
...
//		if (isSlim) {
//			if (slimModel != null) {
//				slimModel.setupAnim(new PlayerStatueRenderState());
//				slimModel.renderToBuffer(poseStack, vertexConsumer, light, OverlayTexture.NO_OVERLAY);
//			}
//		} else {
//			if (model != null) {
//				model.setupAnim(new PlayerStatueRenderState());
