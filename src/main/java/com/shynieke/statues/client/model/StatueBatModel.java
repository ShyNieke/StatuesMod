 ...
 */
public class StatueBatModel extends SegmentedModel<StatueBatEntity> {
     ...
     */
    public void setRotationAngles(StatueBatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
