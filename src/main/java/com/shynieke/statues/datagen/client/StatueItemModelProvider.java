...
//
//	protected static void registerItems(BlockModelGenerators blockModel, ItemModelGenerators itemModel) {
...
//					generator.generateFlatItem(registryObject.get(), ModelTemplates.FLAT_ITEM);
//				} else {
