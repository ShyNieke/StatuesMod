...
public class StatueRecipeProvider extends RecipeProvider {
	...
	protected void buildRecipes(RecipeOutput consumer, HolderLookup.Provider provider) {
		...
		LootRecipeBuilder.loot(Ingredient.of(StatueRegistry.VILLAGER_BR_STATUE.get(), StatueRegistry.VILLAGER_GR_STATUE.get(),
				...
				.result3(Items.EMERALD).save(consumer, Reference.modLoc("loot/villager_statue")); //TODO: Use trading in future
		...
		LootRecipeBuilder.loot(Ingredient.of(StatueRegistry.ZOMBIFIED_PIGLIN_STATUE.get()))
				.result1(Items.ROTTEN_FLESH).result2(Items.GOLD_NUGGET).result3(Items.GOLD_INGOT).save(consumer);

		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.UPGRADEABLE_STATUES), new ArrayList<>())
				.requiresCore().upgradeType(UpgradeType.UPGRADE).save(consumer, Reference.modLoc("upgrade/statue_upgrade"));

		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.UPGRADEABLE_STATUES), List.of(Ingredient.of(Items.GLOW_INK_SAC)))
				.upgradeType(UpgradeType.GLOWING).save(consumer, Reference.modLoc("upgrade/glowing"));

		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.UPGRADEABLE_STATUES), List.of(Ingredient.of(Items.INK_SAC)))
				.upgradeType(UpgradeType.UNGLOWING).save(consumer, Reference.modLoc("upgrade/unglowing"));
		...
		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.UPGRADEABLE_STATUES), List.of(Ingredient.of(Items.ECHO_SHARD),
				...
				.upgradeType(UpgradeType.SPAWNER).save(consumer, Reference.modLoc("upgrade/spawner"));
		...
		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.UPGRADEABLE_STATUES), List.of(Ingredient.of(ItemTags.SKULLS),
				...
				.upgradeType(UpgradeType.DESPAWNER).save(consumer, Reference.modLoc("upgrade/despawner"));
		...
		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.UPGRADEABLE_STATUES), List.of(Ingredient.of(Items.DIAMOND_SWORD))).tier(0)
				.upgradeType(UpgradeType.MOB_KILLER).save(consumer, Reference.modLoc("upgrade/mob_killer"));
		...
		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.UPGRADEABLE_STATUES), List.of(Ingredient.of(Tags.Items.STORAGE_BLOCKS_LAPIS),
				...
				.upgradeType(UpgradeType.MOB_KILLER).save(consumer, Reference.modLoc("upgrade/mob_killer_2"));
		...
		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.UPGRADEABLE_STATUES), List.of(Ingredient.of(Items.EXPERIENCE_BOTTLE))).tier(2)
				.upgradeType(UpgradeType.MOB_KILLER).save(consumer, Reference.modLoc("upgrade/mob_killer_3"));
		...
		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.LOOTABLE_STATUES), List.of(Ingredient.of(Tags.Items.ENDER_PEARLS),
				...
				.upgradeType(UpgradeType.LOOTING).save(consumer, Reference.modLoc("upgrade/looting"));
		...
		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.LOOTABLE_STATUES), List.of(Ingredient.of(Items.HOPPER), Ingredient.of(Items.OBSERVER)))
				.upgradeType(UpgradeType.AUTOMATION).save(consumer, Reference.modLoc("upgrade/automation"));
		...
		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.UPGRADEABLE_STATUES), List.of(Ingredient.of(Tags.Items.DUSTS_REDSTONE),
				...
				.upgradeType(UpgradeType.SPEED).save(consumer, Reference.modLoc("upgrade/speed"));

		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.STATUE_INTERACTABLE), List.of(Ingredient.of(Items.SCULK_SENSOR)))
				.upgradeType(UpgradeType.INTERACTION).save(consumer, Reference.modLoc("upgrade/interaction"));

		UpgradeRecipeBuilder.upgrade(Ingredient.of(StatueTags.UPGRADEABLE_STATUES), List.of(Ingredient.of(Items.NOTE_BLOCK),
						Ingredient.of(Items.AMETHYST_SHARD)))
				.upgradeType(UpgradeType.SOUND).save(consumer, Reference.modLoc("upgrade/sound"));
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(Items.QUARTZ_BLOCK), RecipeCategory.DECORATIONS,
				...
				.save(consumer, Reference.modLoc("display_stand_from_quartz_block_stonecutting"));
