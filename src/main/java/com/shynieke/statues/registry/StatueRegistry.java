...
public class StatueRegistry {
	...
	public static final DeferredBlock<ZombifiedPiglinStatueBlock> ZOMBIFIED_PIGLIN_STATUE = registerStatue("zombified_piglin_statue", () -> new ZombifiedPiglinStatueBlock(blockBuilder()), blockItemBuilder());
