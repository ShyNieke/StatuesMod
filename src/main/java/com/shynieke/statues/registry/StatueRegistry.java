...
public class StatueRegistry {
	...
	public static final RegistryObject<Block> STATUE_TABLE = registerStatue("statue_table", () -> new StatueTableBlock(blockBuilder()), blockItemBuilder());
	...
	public static final RegistryObject<Block> TRANS_BEE_STATUE = registerStatue("trans_bee_statue", () -> new BeeStatueBlock(blockBuilder()), blockItemBuilder());
	...
	public static final RegistryObject<Block> ZOMBIFIED_PIGLIN_STATUE = registerStatue("zombified_piglin_statue", () -> new ZombifiedPiglinStatueBlock(blockBuilder()), blockItemBuilder());
